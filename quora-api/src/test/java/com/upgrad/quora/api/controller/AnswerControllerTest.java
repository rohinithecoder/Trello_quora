...
public class AnswerControllerTest {
    ...
    public void createAnswerWithNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/database_question_uuid/answer/create").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "non_existing_access_token"))
    ...
    public void createAnswerWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/database_question_uuid/answer/create").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "database_accesstoken3"))
                .andExpect(status().isForbidden())
    ...
    public void createAnswerForNonExistingQuestion() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/question/non_existing_question_uuid/answer/create").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "database_accesstoken"))
    ...
    public void editAnswerWithNonExistingAccessToken() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "non_existing_access_token"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-001"));
    }
    ...
    public void editAnswerWithSignedOutUser() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "database_accesstoken3"))
                .andExpect(status().isForbidden())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value("ATHR-002"));
    }
    ...
    public void editNonExistingAnswer() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/non_existing_answer_uuid").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "database_accesstoken1"))
                .andExpect(status().isNotFound())
    ...
    public void editAnswerWithoutOwnership() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/answer/edit/database_answer_uuid").content( "{\"answer\":\"my_answer\"}" ).contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).header("authorization", "database_accesstoken"))
                .andExpect(status().isForbidden())
